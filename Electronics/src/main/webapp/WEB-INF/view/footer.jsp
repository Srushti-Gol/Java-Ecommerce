                            ...
                            <li>
                                <div class="card card-1 border-0">
                                    <div class="card-body p-0 pl-3">
                                        <h6 class="mb-3"><b>Srushti Gol</b></h6> <small>golsrushti1@gmail.com</small><br> <small>7990627969</small>
                                    </div>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-6 col-12 my-auto">
                        <ul class="list-unstyled mt-md-3 mt-5">
                            ...
                            <li>
                                <div class="card card-1 border-0">
                                    <div class="card-body p-0 pl-3">
                                        <h6 class="mb-3"><b>Hetvi Ladani</b></h6> <small>hetvi@gmail.com</small><br> <small>7869544321</small>
                                    </div>
                                </div>
                            </li>
                        </ul>
